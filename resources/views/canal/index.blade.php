...
@section('content')
    ...
    <section class="container-fluid">
        <div class="row">
            <img id="capa-canal" src="{{auth()->user()->capa_canal_src}}" height="500" width="100%"
                 style="object-fit: cover">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-l-2 col-sm-12 col-xs-12 col-md-12 mt-5 mb-5 nav nav-tabs d-block " style="border-bottom: none!important" id="nav-tab"
                    role="tablist">
                    <div class="row">
                ...
                <div class="tab-content col-lg-10 col-l-10 col-sm-12 col-xs-12 col-md-12 mt-5 mb-5">
                    <div class="tab-pane fade in show active" id="menu-envios">
                        @include('components.table_videos_canal')
                    </div>
